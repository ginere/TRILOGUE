...
console.log("Loading file:tree.js ...");/*global document:false, sessionStorage: false, console: false, alert: false, $: false, window: false, jQuery:false,  location:false, debugger:false, navigator:false, localStorage:false */
...
SINGLETON.id="tree";
SINGLETON.template="<li id=\"tree-{{row.id}}\"><span class=\"tree-node\">{{node.title}}</span><ul>{{{childsHtml}}}</ul></li>";
